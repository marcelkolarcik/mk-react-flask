...
import SearchInput from "../front/SearchInput";
        ...
        <div>
            ...
            <Card className={'border-0'}>
                ...
                <Card.Body>
                    ...
                    <Card.Text>
                        <strong>Dates: </strong>
                         {!newRoom ? <div><DateFormater date={bookingCtx.startDate}/> - <DateFormater date={bookingCtx.endDate}/></div>
                         : <div className={  ' p-1 bg-secondary text-light d-flex justify-content-center'}>
                             ...
                             {!correctDates && <span className={'fw-bold p-1 text-warning'}>Check-in must be before check-out</span>}
                    </Card.Text>
                    <Card.Text>
                ...
                <Card.Footer>
                     ...
                     <Button variant="success" onClick={createBooking}
                            className={'text-light text-decoration-underline fw-bold p-1 rounded-0 w-100'}>
                        Book Now!
                    </Button>}
                </Card.Footer>
            </Card>
